...
return [
	...
	'resource' => [
		'db' => [
			...
			'database' => config('database.connections.mysql.database', 'kangan_jwellers'),
			'username' => config('database.connections.mysql.username', 'kangan_kangan'),
			'password' => config('database.connections.mysql.password', 'Kangan@2020'),
